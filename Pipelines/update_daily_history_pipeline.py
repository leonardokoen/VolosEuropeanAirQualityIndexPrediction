...
logger_file_handler = logging.handlers.RotatingFileHandler(
    "status/get_daily_history_status.log",
    maxBytes=1024 * 1024,
    backupCount=1,
    encoding="utf8",
)
...
if __name__ == "__main__":
    ...
    index_filepath = "Pipelines/update_daily_history_index.pkl"
    ...
    try: 
        logger.info(f"[Initiate] Get hopsworks feature group - name: volos_breath_history_daily , version = {1}")
        feature_group = feature_store.get_feature_group(name="volos_breath_history_daily", version = 1)
